...
include('../../../../function/showUnit.php');
	...
	if ($res) 
		...
		while ($row = mysql_fetch_array($res)) 
		{
			...
			echo "<td>".$row['0']."</td>";
			echo "<td>".$row['1']."</td>";
                        echo"<td>"."<a href='./formUpdateUnit.php?kode=".$row['0']."'>Edit Lokasi Cabang</a></td>";
                        echo"<td>"."<a href='./funcDeleteUnit.php?kode=".$row['0']."'>Delete Lokasi Cabang </a></td>";
