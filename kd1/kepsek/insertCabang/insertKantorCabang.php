...
<body>
    ...
    <hr>
    <div>
   <form role="form" method="POST" action="../../../function/insertCabang.php">

        <div class="panel-body">
              <label>Insert Kantor Cabang</label>
              <input class="form-control" name="cabang" type="text">
        </div>

        <div class="panel-body">
		<button type="submit" class="btn btn-default">Submit Button</button>
		<br /><br />	
		<button type="button" class="btn btn-default" value="" onclick="window.location.href='./update/updateCabang.php'" />Update Data Guru </button>  
	</div>
</form>
