                ...
                <table class="table table-hover" border="1">
                    <thead>
                        <tr>
                            ...
                            <th>EDIT  DATA MATA PELAJARAN</th>
                            <th>DELETE DATA MATA PELAJARAN</th>
                        </tr>
                    </thead>
                    <tbody>
...
include('../../../../function/showMatkul.php');
	...
	if ($res) 
		...
		while ($row = mysql_fetch_array($res)) 
		{
			...
			echo "<td>".$row['0']."</td>";
			echo "<td>".$row['1']."</td>";
                        echo"<td>"."<a href='./formUpdateMatkul.php?kode=".$row['0']."'>Edit Nama Mata Pelajaran</a></td>";
                        echo"<td>"."<a href='./funcDeleteMatkul.php?kode=".$row['0']."'>Delete Nama Mata Pelajaran </a></td>";
