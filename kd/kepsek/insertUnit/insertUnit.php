...
<body>
    ...
    <hr>
    <div>
   <form role="form" method="POST" action="../../../function/insertUnit.php">

        <div class="panel-body">
              <label>Insert Unit</label>
...
<br /><br />	
<button type="button" class="btn btn-default" value="" onclick="window.location.href='./update/updateUnit.php'" />Update Data Guru </button>  
</div>
</form>
