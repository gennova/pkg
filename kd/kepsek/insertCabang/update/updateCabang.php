            ...
            <div class="table-responsive">
                <table class="table table-hover" border="1">
                    <thead>
                        <tr>
                            <th>No </th>
                            <th>TEMPAT LOKASI CABANG</th>
                            <th>EDIT  DATA LOKASI CABANG</th>
                            <th>DELETE DATA LOKASI CABANG</th>
                        </tr>
                    </thead>
                    <tbody>
...
include('../../../../function/showCabang.php');
	...
	if ($res) 
		...
		while ($row = mysql_fetch_array($res)) 
		{
			...
			echo "<td>".$row['0']."</td>";
			echo "<td>".$row['1']."</td>";
                        echo"<td>"."<a href='./formUpdateCabang.php?kode=".$row['0']."'>Edit Lokasi Cabang</a></td>";
                        echo"<td>"."<a href='./funcDeleteCabang.php?kode=".$row['0']."'>Delete Lokasi Cabang </a></td>";
