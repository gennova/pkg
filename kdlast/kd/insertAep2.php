...
include('../function/showGuru.php');
	...
	$p=0;	
					...
					echo "<td>".$row['semester']." </td>";
                        ...
                        echo"<td>"."<a href='./insertAep.php?kodespv=".$row['idspv']." && guruspv=".$row['guruspv']." && ambilguru=".$row['namaguru']." && ambilcabang=".$row['kantorcabang']." && ambilunit=".$row['unit']." && ambilmatkul=".$row['matapelajaran']." && ambilkelas=".$row['kelas']." && semester=".$row['semester']." && years=".$row['tahun']."  && ambilsemester=".$row['semester']."'>Mulai Evaluasi </a></td>";
