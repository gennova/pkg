...
<body>
    ...
    <hr>
    <div>
   <form role="form" method="POST" action="../../../function/insertMatkul.php">

        <div class="panel-body">
              <label>Insert Mata Pelajaran</label>
		...
		<br /><br />	
		<button type="button" class="btn btn-default" value="" onclick="window.location.href='./update/updateMatkul.php'" />Update Data Guru </button>  
	</div>
</form>
