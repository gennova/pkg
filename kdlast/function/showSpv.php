s<?php
	...
	function showSpv()
	{
		$sql= "select * from tblUserSupervisor";
	...
	function showSpvUpdate($new)
	{
		$sql= "select * from tblUserSupervisor where id=$new";
		$new= mysql_query($sql);
	...
	function deleteSpv($index)
	{
		$sql= "delete from tblUserSupervisor where id='$index'";
				$query=mysql_query($sql);
		return $query;
	}
