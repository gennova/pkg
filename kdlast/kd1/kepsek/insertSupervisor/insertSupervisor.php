...
<body>
    ...
    <hr>
    <div>
   <form role="form" method="POST" action="../../../function/insertSpv.php">
	 ...
	 <div class="panel-body">
		...
		<br /><br />	
		<button type="button" class="btn btn-default" value="" onclick="window.location.href='./update/updateGuru.php'" />Update Data Guru </button>  
	 </div>
</form>
