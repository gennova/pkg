...
?>
<form method="GET" action ="../form/insertData6.php">
  
	<input type="hidden" name="indexuser" value="<?php echo $indexuser;?>">
  <div align = "Center">
    <table border =1 >
	...
	<input type="hidden" name="bab5" value="<?php echo $_GET['bab5'];?>">
	...
	<input type="hidden" name="no17" value="<?php echo $_GET['no17'];?>">
	<input type="hidden" name="no18" value="<?php echo $_GET['no18'];?>">
	<input type="hidden" name="no19" value="<?php echo $_GET['no19'];?>">
	...
	<input type="hidden" name="waktusekarang" value="<?php echo $_GET['waktusekarang'];?>">
        ...
        <tr>
            ...
            <td class="td"> <input type="radio" name="duapuluh" value="1"> </td>
